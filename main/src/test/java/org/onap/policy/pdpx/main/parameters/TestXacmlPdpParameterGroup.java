...
public class TestXacmlPdpParameterGroup {
    ...
    public void testXacmlPdpParameterGroup() {
        ...
        final XacmlPdpParameterGroup pdpxParameters = new XacmlPdpParameterGroup(
                CommonTestData.PDPX_GROUP_NAME, restServerParameters);
        ...
        assertEquals(restServerParameters.getUserName(),
                pdpxParameters.getRestServerParameters().getUserName());
        assertEquals(restServerParameters.getPassword(),
                pdpxParameters.getRestServerParameters().getPassword());
    ...
    public void testXacmlPdpParameterGroup_NullName() {
        final RestServerParameters restServerParameters = commonTestData.getRestServerParameters(false);
        final XacmlPdpParameterGroup pdpxParameters = new XacmlPdpParameterGroup(null,
