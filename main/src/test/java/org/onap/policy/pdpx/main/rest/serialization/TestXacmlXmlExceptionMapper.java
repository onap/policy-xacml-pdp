...
public class TestXacmlXmlExceptionMapper {
    ...
    public void testToResponse() throws CoderException {
        IOException writeToEx = new IOException("failed to convert a dom response to a string");
        IOException readFromEx = new IOException("failed to decode incoming request string to a dom request");
