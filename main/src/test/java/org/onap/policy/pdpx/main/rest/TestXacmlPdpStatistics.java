...
public class TestXacmlPdpStatistics {
    ...
    private void updateXacmlPdpStatistics() {
        XacmlPdpStatisticsManager.updateTotalXacmlPdpCount();
        XacmlPdpStatisticsManager.updateXacmlPdpSuccessCount();
        XacmlPdpStatisticsManager.updateXacmlPdpFailureCount();
        XacmlPdpStatisticsManager.updateTotalDownloadCount();
        XacmlPdpStatisticsManager.updateDownloadSuccessCount();
        XacmlPdpStatisticsManager.updateDownloadFailureCount();
    }

    private void validateReport(final StatisticsReport report, final int count, final int code) {
        assertEquals(code, report.getCode());
        assertEquals(count, report.getTotalXacmlPdpCount());
        assertEquals(count, report.getXacmlPdpSuccessCount());
        assertEquals(count, report.getXacmlPdpFailureCount());
