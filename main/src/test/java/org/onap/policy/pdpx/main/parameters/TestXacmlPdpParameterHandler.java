...
public class TestXacmlPdpParameterHandler {
    ...
    public void testParameterHandlerNoParameterFile() throws PolicyXacmlPdpException {
        ...
        try {
            new XacmlPdpParameterHandler().getParameters(noArguments);
    ...
    public void testParameterHandlerEmptyParameters() throws PolicyXacmlPdpException {
        ...
        try {
            new XacmlPdpParameterHandler().getParameters(emptyArguments);
            fail("test should throw an exception here");
        } catch (final Exception e) {
    ...
    public void testParameterHandlerBadParameters() throws PolicyXacmlPdpException {
        ...
        try {
            new XacmlPdpParameterHandler().getParameters(badArguments);
            fail("test should throw an exception here");
        } catch (final Exception e) {
    ...
    public void testParameterHandlerInvalidParameters() throws PolicyXacmlPdpException {
        ...
        try {
            new XacmlPdpParameterHandler().getParameters(invalidArguments);
            fail("test should throw an exception here");
        } catch (final Exception e) {
    ...
    public void testParameterHandlerNoParameters() throws PolicyXacmlPdpException {
        ...
        try {
            ...
            String expMsg = "validation error(s) on parameters from \"parameters/NoParameters.json\"\nparameter group "
                    + "\"null\" type \"org.onap.policy.pdpx.main.parameters.XacmlPdpParameterGroup\" INVALID, parameter "
    ...
    public void testXacmlPdpParameterGroup_InvalidName() throws PolicyXacmlPdpException {
        final String[] xacmlPdpConfigParameters =
        { "-c", "parameters/XacmlPdpConfigParameters_InvalidName.json" };
    ...
    @Test
    public void testXacmlPdpParameterGroup_InvalidRestServerParameters()
            throws PolicyXacmlPdpException, IOException {
        final String[] xacmlPdpConfigParameters =
