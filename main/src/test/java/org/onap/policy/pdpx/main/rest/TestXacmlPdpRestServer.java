...
public class TestXacmlPdpRestServer {
    ...
    private static final Logger LOGGER = FlexLogger.getLogger(TestXacmlPdpRestServer.class);
    ...
    public void testHealthCheckFailure() throws InterruptedException {
        final String reportString = "Report [name=Policy Xacml PDP, url=self, healthy=false, code=500, message=not alive]";
