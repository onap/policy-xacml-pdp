...
public class TestXacmlPdpRestServer {
    ...
    public void teardown() {
        ...
        } catch (InterruptedException | IOException | PolicyXacmlPdpException e) {
    ...
    public void testHttpsHealthCheckSuccess() {
        try {
            ...
            LOGGER.error("testHttpsHealthCheckSuccess failed", e);
            fail("Test should not throw an exception");
        }
    }

    @Test
    public void testStatistics_200() {
        try {
            main = startXacmlPdpService(true);
            ...
            LOGGER.error("testXacmlPdpStatistics_200 failed", e);
            fail("Test should not throw an exception");
        }
    }

    @Test
    public void testStatistics_500() {
        final RestServerParameters restServerParams = new CommonTestData().getRestServerParameters(false);
        restServerParams.setName(CommonTestData.PDPX_GROUP_NAME);
        restServer = new XacmlPdpRestServer(restServerParams);
        try {
            ...
            LOGGER.error("testPapStatistics_500 failed", e);
            fail("Test should not throw an exception");
        }
    }

    @Test
    public void testHttpsStatistic() {
        try {
            main = startXacmlPdpService(false);
            ...
            LOGGER.error("testHttpsDistributionStatistic failed", e);
            fail("Test should not throw an exception");
        }
    }
