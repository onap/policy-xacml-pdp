...
public class XacmlPdpHeartbeatPublisher extends TimerTask {
    ...
    public XacmlPdpHeartbeatPublisher start(PdpState state) {
        return new XacmlPdpHeartbeatPublisher(topicSinkClient, state);
    }
    ...
    public XacmlPdpHeartbeatPublisher updateInternalState(TopicSinkClient topicSinkClient, PdpState state) {
        terminate();
        return new XacmlPdpHeartbeatPublisher(topicSinkClient, state);
    }
