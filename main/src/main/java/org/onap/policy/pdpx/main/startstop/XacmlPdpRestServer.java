...
public class XacmlPdpRestServer extends RestServer {
    ...
    private final List<HttpServletServer> xacmlPdpServers;
    ...
    public XacmlPdpRestServer(final RestServerParameters restServerParameters,
        ...
        Properties props = super.getServerProperties(restServerParameters,
                String.join(",", getJaxrsProviderNames(jaxrsProviders)));
        //
        // Override http serialization provider
        //
        final String svcpfx =
        ...
        this.xacmlPdpServers = factory.getServerFactory().build(props);

        for (HttpServletServer server : this.xacmlPdpServers) {
    ...
    private List<String> getJaxrsProviderNames(Class<?>... jaxrsProviders) {
        List<String> providerNames = new ArrayList<>();
        for (Class<?> provClass : jaxrsProviders) {
            providerNames.add(provClass.getName());
        }
