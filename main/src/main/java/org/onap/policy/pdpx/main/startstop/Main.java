...
public class Main {
    ...
    public Main(final String[] args) {
        ...
        try {
            ...
            LOGGER.error("start of policy xacml pdp service failed, used parameters are " + Arrays.toString(args),
                    e);
            return;
        }
    ...
    /**
     * The Class PolicyXacmlPdpShutdownHookClass terminates the policy xacml pdp service when its run method is
     * called.
     */
