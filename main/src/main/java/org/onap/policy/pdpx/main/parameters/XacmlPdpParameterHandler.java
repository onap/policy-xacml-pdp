...
/**
 * This class handles reading, parsing and validating of policy xacml pdp parameters from JSON files.
 */
public class XacmlPdpParameterHandler {
    private static final Logger LOGGER = FlexLogger.getLogger(XacmlPdpParameterHandler.class);
