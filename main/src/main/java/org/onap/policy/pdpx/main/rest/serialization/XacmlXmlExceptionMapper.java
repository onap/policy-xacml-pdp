...
/**
 * Catches xml exceptions when decoding a REST xacml request and converts them from an HTTP 500
...
public class XacmlXmlExceptionMapper implements ExceptionMapper<DOMStructureException> {
    ...
    @Override
    public Response toResponse(DOMStructureException exception) {
