...
public class NativePdpApplicationTranslator implements ToscaPolicyTranslator {
    ...
    private Boolean checkIfWordOperator(Object token, StreamTokenizer tokenizer)
        ...
        try {
            ...
            LOGGER.error("POLICY-500: Error parsing expr, could not get next token.");
            throw new
                ToscaPolicyConversionException("POLICY-500: Error parsing expr, could not get next token.");
        }
        ...
        try {
            ...
            if (Boolean.FALSE.equals(isWordOperator)) {
                ...
                if (Boolean.TRUE.equals(isComparisonOperator(value))) {
                    ...
                    isProcessed = checkBracketToken(isWordOperator, token, value, tokenizer,
    operators, operands, factory);
                }
            }
    ...
    private Boolean checkBracketToken(Boolean isWordOperator,
                                   Object token,
                                   char value,
