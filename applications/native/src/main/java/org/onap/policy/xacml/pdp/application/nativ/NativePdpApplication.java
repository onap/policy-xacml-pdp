...
public class NativePdpApplication extends StdXacmlApplicationServiceProvider {
    ...
    public boolean canSupportPolicyType(ToscaPolicyTypeIdentifier policyTypeId) {
        return supportedPolicyTypes.contains(policyTypeId);
    }
     ...
     * @param incomingRequestStirng the incoming request as string
     * @return the pair of response string and native xacml response
     */
    public Pair<String, Response> makeDecision(ContentType contentType, String incomingRequestStirng) {
        //
        // Convert to a XacmlRequest
        //
        Request xacmlRequest = this.getTranslator().convertRequest(contentType, incomingRequestStirng);
        //
        // Now get a decision
        //
        ...
        //
        return Pair.of(this.getTranslator().convertResponse(contentType, xacmlResponse), xacmlResponse);
    }
}
