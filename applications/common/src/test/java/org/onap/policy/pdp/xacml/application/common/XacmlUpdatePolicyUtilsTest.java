...
public class XacmlUpdatePolicyUtilsTest {
    ...
    public void test() {
        assertThatCode(() -> {
            ...
            //
            XacmlUpdatePolicyUtils.setXacmlRootProperties(properties, rootPath);
            XacmlUpdatePolicyUtils.setXacmlReferencedProperties(properties, path1, path2);
            //
            ...
            //
            XacmlUpdatePolicyUtils.setXacmlRootProperties(properties, rootPath);
            XacmlUpdatePolicyUtils.setXacmlReferencedProperties(properties, policySetPath);
            //
            // Dump this out so I can see what I'm doing
            //
            for (Entry<Object, Object> entry : properties.entrySet()) {
