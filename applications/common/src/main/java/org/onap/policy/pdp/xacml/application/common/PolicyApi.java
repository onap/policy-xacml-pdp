...
public class PolicyApi {
    private static Logger logger = LoggerFactory.getLogger(PolicyApi.class);
     ...
     */
    public PolicyApi(BusTopicParams params) throws PolicyApiException {
        try {
            httpClient = new JerseyClient(params);
