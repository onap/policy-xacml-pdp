...
public abstract class StdBaseTranslator implements ToscaPolicyTranslator {
     ...
     * obligations. This method must be overridden an be implemented for the specific application.
     *
    ...
    protected <T> T addObligation(T ruleOrPolicy, String policyId, String jsonPolicy, Integer weight,
        ...
        if (! Strings.isNullOrEmpty(policyId)) {
            addAttributeToObligation(obligation, ToscaDictionary.ID_OBLIGATION_POLICY_ID,
                    ToscaDictionary.ID_OBLIGATION_POLICY_ID_DATATYPE,
                    ToscaDictionary.ID_OBLIGATION_POLICY_ID_CATEGORY, policyId);
        }
        //
        // Check if the policy contents exist
        //
        if (! Strings.isNullOrEmpty(jsonPolicy)) {
            addAttributeToObligation(obligation, ToscaDictionary.ID_OBLIGATION_POLICY_CONTENT,
                    ToscaDictionary.ID_OBLIGATION_POLICY_CONTENT_DATATYPE,
                    ToscaDictionary.ID_OBLIGATION_POLICY_CONTENT_CATEGORY, jsonPolicy);
        }
        //
        // If the weight exists
        //
        if (weight != null) {
            addAttributeToObligation(obligation, ToscaDictionary.ID_OBLIGATION_POLICY_WEIGHT,
                    ToscaDictionary.ID_OBLIGATION_POLICY_WEIGHT_DATATYPE,
                    ToscaDictionary.ID_OBLIGATION_POLICY_WEIGHT_CATEGORY, weight);
        }
        //
        // If the policy type exists
        //
        if (! Strings.isNullOrEmpty(policyType)) {
            addAttributeToObligation(obligation, ToscaDictionary.ID_OBLIGATION_POLICY_TYPE,
                    ToscaDictionary.ID_OBLIGATION_POLICY_TYPE_DATATYPE,
                    ToscaDictionary.ID_OBLIGATION_POLICY_TYPE_CATEGORY, policyType);
        }
        //
        // Sanity check
        //
    ...
    /**
     * Creates the necessary objects to insert into the obligation.
     *
     ...
     */
    protected ObligationExpressionType addAttributeToObligation(ObligationExpressionType obligation,
