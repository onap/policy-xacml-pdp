...
public class MatchablePolicyType {
    ...
    public static MatchableProperty handlePrimitive(String property, ToscaProperty toscaProperty) {
        ...
        if (TOSCA_PRIMITIVE_STRING.equals(toscaProperty.getType())) {
            return new MatchableProperty(property, new MatchablePropertyTypeString(toscaProperty));
        } else if (TOSCA_PRIMITIVE_INTEGER.equals(toscaProperty.getType())) {
            return new MatchableProperty(property, new MatchablePropertyTypeInteger(toscaProperty));
        } else if (TOSCA_PRIMITIVE_BOOLEAN.equals(toscaProperty.getType())) {
            return new MatchableProperty(property, new MatchablePropertyTypeBoolean(toscaProperty));
        } else if (TOSCA_PRIMITIVE_FLOAT.equals(toscaProperty.getType())) {
            return new MatchableProperty(property, new MatchablePropertyTypeFloat(toscaProperty));
        } else if (TOSCA_PRIMITIVE_TIMESTAMP.equals(toscaProperty.getType())) {
            return new MatchableProperty(property, new MatchablePropertyTypeTimestamp(toscaProperty));
        }
    ...
    public static MatchableProperty handlePrimitive(String property, ToscaEntrySchema toscaSchema) {
        if (TOSCA_PRIMITIVE_STRING.equals(toscaSchema.getType())) {
            return new MatchableProperty(property, new MatchablePropertyTypeString(toscaSchema));
        } else if (TOSCA_PRIMITIVE_INTEGER.equals(toscaSchema.getType())) {
            return new MatchableProperty(property, new MatchablePropertyTypeInteger(toscaSchema));
        } else if (TOSCA_PRIMITIVE_BOOLEAN.equals(toscaSchema.getType())) {
            return new MatchableProperty(property, new MatchablePropertyTypeBoolean(toscaSchema));
        } else if (TOSCA_PRIMITIVE_FLOAT.equals(toscaSchema.getType())) {
            return new MatchableProperty(property, new MatchablePropertyTypeFloat(toscaSchema));
        } else if (TOSCA_PRIMITIVE_TIMESTAMP.equals(toscaSchema.getType())) {
            return new MatchableProperty(property, new MatchablePropertyTypeTimestamp(toscaSchema));
        }
    ...
    public static boolean isPrimitive(@NonNull String type) {
        //@formatter:off
        return TOSCA_PRIMITIVE_STRING.equalsIgnoreCase(type)
                || TOSCA_PRIMITIVE_INTEGER.equalsIgnoreCase(type)
                || TOSCA_PRIMITIVE_FLOAT.equalsIgnoreCase(type)
                || TOSCA_PRIMITIVE_BOOLEAN.equalsIgnoreCase(type)
                || TOSCA_PRIMITIVE_TIMESTAMP.equalsIgnoreCase(type);
        //@formatter:on
    }
