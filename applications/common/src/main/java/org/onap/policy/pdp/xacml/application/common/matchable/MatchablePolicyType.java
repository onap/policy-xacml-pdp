...
public class MatchablePolicyType {
    ...
    @FunctionalInterface
    interface ConstructMatchableProperty {
        MatchableProperty construct(String property, ToscaProperty toscaProperty);
    }

    @FunctionalInterface
    interface ConstructMatchableSchema {
        MatchableProperty construct(String property, ToscaEntrySchema toscaSchema);
    }

    private static final Map<String, ConstructMatchableProperty> primitivePropertyConstructs = new HashMap<>();
    private static final Map<String, ConstructMatchableSchema> primitiveSchemaConstructs = new HashMap<>();

    private static Map<String, Function<ToscaProperty, MatchablePropertyTypeBase<?>>> mapPrimitives = Map.of(
    ...
    static {
        primitivePropertyConstructs.put(TOSCA_PRIMITIVE_STRING, (String property, ToscaProperty toscaProperty) -> (
                new MatchableProperty(property, new MatchablePropertyTypeString(toscaProperty))));
        primitivePropertyConstructs.put(TOSCA_PRIMITIVE_INTEGER, (String property, ToscaProperty toscaProperty) -> (
                new MatchableProperty(property, new MatchablePropertyTypeInteger(toscaProperty))));
        primitivePropertyConstructs.put(TOSCA_PRIMITIVE_FLOAT, (String property, ToscaProperty toscaProperty) -> (
                new MatchableProperty(property, new MatchablePropertyTypeFloat(toscaProperty))));
        primitivePropertyConstructs.put(TOSCA_PRIMITIVE_BOOLEAN, (String property, ToscaProperty toscaProperty) -> (
                new MatchableProperty(property, new MatchablePropertyTypeBoolean(toscaProperty))));
        primitivePropertyConstructs.put(TOSCA_PRIMITIVE_TIMESTAMP, (String property, ToscaProperty toscaProperty) -> (
                new MatchableProperty(property, new MatchablePropertyTypeTimestamp(toscaProperty))));

        primitiveSchemaConstructs.put(TOSCA_PRIMITIVE_STRING, (String property, ToscaEntrySchema toscaSchema) -> (
                new MatchableProperty(property, new MatchablePropertyTypeString(toscaSchema))));
        primitiveSchemaConstructs.put(TOSCA_PRIMITIVE_INTEGER, (String property, ToscaEntrySchema toscaSchema) -> (
                new MatchableProperty(property, new MatchablePropertyTypeInteger(toscaSchema))));
        primitiveSchemaConstructs.put(TOSCA_PRIMITIVE_FLOAT, (String property, ToscaEntrySchema toscaSchema) -> (
                new MatchableProperty(property, new MatchablePropertyTypeFloat(toscaSchema))));
        primitiveSchemaConstructs.put(TOSCA_PRIMITIVE_BOOLEAN, (String property, ToscaEntrySchema toscaSchema) -> (
                new MatchableProperty(property, new MatchablePropertyTypeBoolean(toscaSchema))));
        primitiveSchemaConstructs.put(TOSCA_PRIMITIVE_TIMESTAMP, (String property, ToscaEntrySchema toscaSchema) -> (
                new MatchableProperty(property, new MatchablePropertyTypeTimestamp(toscaSchema))));
    }
    ...
    /**
     * handlePrimitive - handles a primitive type.
     *
    ...
    public static MatchableProperty handlePrimitive(String property, ToscaProperty toscaProperty) {
        ...
        Function<ToscaProperty, MatchablePropertyTypeBase<?>> function = mapPrimitives.get(toscaProperty.getType());
        if (function != null) {
            return new MatchableProperty(property, function.apply(toscaProperty));
        }
        /*
        ConstructMatchableProperty construct = primitivePropertyConstructs.get(toscaProperty.getType());
        if (construct != null) {
            return construct.construct(property, toscaProperty);
        }
        */
    ...
    public static MatchableProperty handlePrimitive(String property, ToscaEntrySchema toscaSchema) {
        Function<ToscaProperty, MatchablePropertyTypeBase<?>> function = mapPrimitives.get(toscaSchema.getType());
        if (function != null) {
            return new MatchableProperty(property, function.apply(toscaSchema)); // compilation err wants ToscaProperty
        }
        /*
        ConstructMatchableSchema construct = primitiveSchemaConstructs.get(toscaSchema.getType());
        if (construct != null) {
            return construct.construct(property, toscaSchema);
        }
        */
    ...
    public static boolean isPrimitive(@NonNull String type) {
        return primitivePropertyConstructs.containsKey(type);
    }
