...
public class MatchablePolicyType {
    ...
    public static final Map<String, ConstructMatchableProperty> primitivePropertyConstructs = new HashMap<>();
    public static final Map<String, ConstructMatchableSchema> primitiveSchemaConstructs = new HashMap<>();
