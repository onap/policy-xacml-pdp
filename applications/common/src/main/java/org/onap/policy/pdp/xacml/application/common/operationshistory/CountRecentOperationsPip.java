...
public class CountRecentOperationsPip extends StdOnapPip {
    ...
    private long doDatabaseQuery(String actor, String operation, String target, int timeWindowVal,
        ...
        //
        ChronoUnit scale = null;
        switch (timeWindowScale.toLowerCase()) {
            case "second":
                scale = ChronoUnit.SECONDS;
                break;
            case "minute":
                scale = ChronoUnit.MINUTES;
                break;
            case "hour":
                scale = ChronoUnit.HOURS;
                break;
            case "day":
                scale = ChronoUnit.DAYS;
                break;
            case "week":
                scale = ChronoUnit.WEEKS;
                break;
            case "month":
                scale = ChronoUnit.MONTHS;
                break;
            case "year":
                scale = ChronoUnit.YEARS;
                break;
            default:
                //
                // Unsupported
        ...
        try {
            ...
            // Set up query
            //
            String strQuery = "select count(e) from Dbao e"
