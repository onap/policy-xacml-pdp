...
public class OptimizationPdpApplicationTest {
    ...
    public void test04OptimizationDefaultHpa() throws CoderException, FileNotFoundException, IOException,
        ...
        // Add in policy type
        //
        List<String> policyTypes = Arrays.asList("onap.policies.optimization.HpaPolicy");
    ...
    public void test11OptimizationPolicyTypeDefault() throws CoderException {
        ...
        // Add in policy type
        //
        List<String> policyTypes = Arrays.asList("onap.policies.optimization.AffinityPolicy");
        baseRequest.getResource().put("policy-type", policyTypes);
        //
    ...
    private void cleanOutResources() {
        ...
        if (((List<String>)baseRequest.getResource().get("policy-type")) != null) {
            ((List<String>)baseRequest.getResource().get("policy-type")).clear();
        }
    }
}
