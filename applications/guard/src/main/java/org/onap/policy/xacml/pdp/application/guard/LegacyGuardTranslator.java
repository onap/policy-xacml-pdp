...
public class LegacyGuardTranslator implements ToscaPolicyTranslator {
    ...
    private PolicyType convertPolicy(Entry<String, Object> entrySet) throws ToscaPolicyConversionException {
        ...
        //
        RuleType rule = generatePermitRule(policyName, (Map<String, Object>) policyDefinition.get("properties"));
        //
    ...
    private static RuleType generatePermitRule(String policyName, Map<String, Object> properties) {
        //
        // Get the possible properties
        //
        Integer limit = null;
        ...
        //
        // See if its possible to generate a time in range
        //
    ...
    private static ApplyType generateCountCheck(Integer limit, String timeWindow, String timeUnits) {
        AttributeDesignatorType designator = new AttributeDesignatorType();
        designator.setAttributeId(ToscaDictionary.ID_RESOURCE_GUARD_REQUESTID.stringValue());
        ...
        designator.setIssuer("org:onap:xacml:guard:historydb:tw:" + timeWindow + ":" + timeUnits);
