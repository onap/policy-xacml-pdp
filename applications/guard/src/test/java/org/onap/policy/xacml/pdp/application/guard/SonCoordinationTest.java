...
public class SonCoordinationTest {
    ...
    public static void setup() throws Exception {
        ...
        requestVpciNode1 = gson.decode(
            TextFileUtils
                .getTextFileAsString("src/test/resources/requests/coordination.cl.vPci.node.1.json"),
            DecisionRequest.class);
        requestVsonhNode1 = gson.decode(
            TextFileUtils
                .getTextFileAsString("src/test/resources/requests/coordination.cl.vSonh.node.1.json"),
            DecisionRequest.class);
